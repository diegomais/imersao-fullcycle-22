...
export type KafkaServerOptions = {
  server: MakePropRequired<
    ...
    'bootstrap.servers'
  >;
  consumer?: MakePropOptional<KafkaJS.ConsumerConfig, 'groupId'>;
  subscribe?: KafkaJS.ConsumerSubscribeTopics;
  ...
  implements CustomTransportStrategy
{
  ...
  public async bindEvents(consumer: KafkaJS.Consumer) {
  ...
  public getMessageHandler(): KafkaJS.EachMessageHandler {
